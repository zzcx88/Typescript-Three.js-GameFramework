...
class CEngineRafraction : public CPlane
{
public:
...
public:
	CEngineRafraction();
	CEngineRafraction(int nIndex, ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, float fWidth, float fHeight, float fDepth);
	virtual ~CEngineRafraction();
