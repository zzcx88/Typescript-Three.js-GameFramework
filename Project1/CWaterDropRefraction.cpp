#include "stdafx.h"
#include "CWaterDropRefraction.h"
#include "CEngineRafraction.h"
#include "CPlaneMesh.h"
#include "CTestScene.h"
#include "CShaderManager.h"

CWaterDropRefraction::CWaterDropRefraction()
{
}

CWaterDropRefraction::CWaterDropRefraction(int nIndex, ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, float fWidth, float fHeight, float fDepth)
{
...
void CWaterDropRefraction::Animate(float fTimeElapsed)
{
...
void CWaterDropRefraction::TextureAnimate()
{
}

void CWaterDropRefraction::SetLookAt(XMFLOAT3& xmfTarget)
{
...
void CWaterDropRefraction::OnPreRender(ID3D12Device* pd3dDevice, ID3D12CommandQueue* pd3dCommandQueue, ID3D12Fence* pd3dFence, HANDLE hFenceEvent)
{
	/////////////////////새 카메라를 만들었을 경우////////////////////////
...
void CWaterDropRefraction::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	if (GET_MANAGER<ObjectManager>()->GetObjFromTag(L"player", OBJ_PLAYER)->m_bEye_fixation == false)
	{
