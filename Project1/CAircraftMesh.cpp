...
CAircraftMesh::CAircraftMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList) : CMesh(pd3dDevice, pd3dCommandList)
{
}

CAircraftMesh::~CAircraftMesh()
{
...
void CAircraftMesh::ReleaseUploadBuffers()
{
...
void CAircraftMesh::OnPreRender(ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
