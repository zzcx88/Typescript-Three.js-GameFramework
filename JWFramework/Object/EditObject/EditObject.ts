...
import { CameraMode, KeyState, ObjectType, SceneType } from '../../enum';
...
import type { R60M } from '../InGameObject/Weapons/IRMissile/R60M';
import { SceneManager } from '../../Manager/SceneManager';
import { UnitConvertManager } from '../../Manager/UnitConvertManager';
...
export class EditObject extends GameObject
{
    ...
    public InitializeAfterLoad()
    {
        ...
        const guiSrt = GUIManager.getInstance().GUI_SRT;
